...
# 8x H100 80GB, DeepSpeed ZeRO-3 (no CPU offload), 720P, 49 frames
# Stage 1: Fast training at lower frame count

set -e

# Use conda env's Python/accelerate explicitly
...
accelerate launch --config_file examples/wanvideo/model_training/full/accelerate_config_14B_fast.yaml \
  ...
  --output_path "./models/train/TextVACE_14B_sft_49f" \
